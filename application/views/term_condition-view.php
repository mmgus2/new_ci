<header class="location black-font">
    <div class="parallax-window" data-parallax="scroll" data-image-src="../../assets/img/page/TermsandConditions.jpeg">
        <div class="container">
...
<section class="bg-light-gray">
    <div class="container background-location">
        ...
        <p>These terms and conditions outline the rules and regulations for the use of  Delta Solutions's Website. <br />
            <span style="text-transform: capitalize;">Delta Solutions</span> is located at:<br />
        <address>
            Delta Solutions , <br />
            Monash University, Victoria 3125<br />
            Australia<br />
        </address>
        By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Delta Solutions's website if you do not accept all of the terms and conditions stated on this page.
        </p>
        ...
        <ol>
            ...
            <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information, material and data ('Comments') in areas of the website. Delta Solutions does not screen, edit, publish or review Comments prior to their appearance on the website and Comments do not reflect the views or opinions of Delta Solutions, its agents or affiliates. Comments reflect the view and opinion of the person who posts such view or opinion. To the extent permitted by applicable laws Delta Solutions shall not be responsible or liable for the Comments or for any loss cost, liability, damages or expenses caused and or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</li>
            <li>Delta Solutions reserves the right to monitor all Comments and to remove any Comments which it considers in its absolute discretion to be inappropriate, offensive or otherwise in breach of these Terms and Conditions.</li>
            ...
            <li>You hereby grant to <strong>Delta Solutions</strong> a non-exclusive royalty-free license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</li>
        </ol>
        ...
        <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website, you must notify us by sending an e-mail to <a href="mailto:navjotkaur890@gmail.com" title="send an email to deltasolutions@gmail.com">navjotkaur890@gmail.com</a>. Please include your name, your organization name, contact information (such as a phone number and/or e-mail address) as well as the URL of your site, a list of any URLs from which you intend to link to our Web site, and a list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a response.</p>
        ...
        <h2>Credit</h2>
        <p>This Terms and conditions page was created at <a href="http://termsandconditionstemplate.com">terms and conditions</a> template generator</p>
